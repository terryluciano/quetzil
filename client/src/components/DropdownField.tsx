...
export const DropdownField = ({
	...
	return (
		<div ref={dropdownRef} className='relative w-full'>
			...
			/>
			<div
				className={`absolute top-full right-0 z-10 w-full transition-all duration-150 origin-top h-auto overflow-y-scroll flex flex-col justify-start items-center ${
