...
const AuthFormWrapper = ({
    ...
    return (
        ...
        >
            <div className="flex-center py-3 w-full bg-primary">
            ...
            <button
                {...buttonProps}
                className={twMerge(
                    "bg-primary hover:bg-primary-hover transition-all duration-200 ease-in-out text text-xl font-medium font-Fira-Sans px-2 rounded h-10 hover:text-text-hover",
